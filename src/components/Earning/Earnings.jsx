  ...
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3 mt-6">
      {EarningData.map((earnings, i) => (
        <div
          className="p-3 border border-[#4d4d4d] rounded-2xl w-full transition-transform duration-300 hover:scale-105 hover:shadow-lg"
          key={i}
        >
          ...
          <div className="other flex items-baseline justify-between mt-4">
            ...
            <div className="payment-per-month bg-[#1a1a1a] px-3 py-1 rounded-2xl">
