    ...
    return (
        ...
        >
            <div className="relative">
                <div className={`absolute inset-0 bg-gradient-to-br ${note.background} overflow-hidden rounded-xl opacity-90`}></div>
                    ...
                    <div className="prose prose-lg py-3">
                        <div
                            ...
                            dangerouslySetInnerHTML={{
                                __html: DOMPurify.sanitize(note.content.length > 600 ? `${note.content.slice(0, 600)}...` : note.content),
                            }}
                        ></div>
                    </div>
